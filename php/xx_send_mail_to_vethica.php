...
/*
    $headers  = 'From: info@vethica.com' . "\r\n";
    $headers .= 'Reply-To: info@vethica.com' . "\r\n";
    $headers .= 'Return-Path: info@vethica.com' ."\r\n";     
*/
    // recup des infos de l'envoyeur...
    ...
    $to = 'info@vethica.com,pbenoist@emergensoft.fr';
    $message .= '<br>';
